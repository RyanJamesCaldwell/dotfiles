...
local c = {
  bg0 = '#1a1324', -- base background
  bg1 = '#221a2e', -- panels, cursor line
  bg2 = '#2d2340', -- selection, popup menus
  bg3 = '#3a2e51', -- borders, line numbers
  bg4 = '#4b3d68', -- dim UI
  fg0 = '#f2eaf8', -- brightest text
  fg1 = '#d6c9e6', -- normal text
  fg2 = '#a294b8', -- muted text
  fg3 = '#7a6c90', -- comments
  accent = '#c7a9f0', -- primary
  accent2 = '#eba8c8', -- secondary
  accent3 = '#9d7fd0', -- deep
  str = '#a3dcc0', -- strings
  num = '#e9cf9e', -- numbers, constants
  kw = '#c7a9f0', -- keywords
  fn = '#a6c6ee', -- functions
  typ = '#eba8c8', -- types
  spec = '#e9cf9e', -- special
  ...
  hint = '#a3dcc0', -- hint
  add = '#a3dcc0', -- git add
  change = '#e9cf9e', -- git change
  del = '#f08a9c', -- git delete
}
