-- abyss - Deep water. Teal-navy base with aqua, coral and seafoam.
-- Generated: keep the whole family in step rather than editing one file by hand.
local M = {}

local c = {
  bg0 = '#101c24', -- base background
  bg1 = '#16252f', -- panels, cursor line
  bg2 = '#1e313e', -- selection, popup menus
  bg3 = '#2a4150', -- borders, line numbers
  bg4 = '#395667', -- dim UI
  fg0 = '#e8f4f8', -- brightest text
  fg1 = '#c5dce6', -- normal text
  fg2 = '#8fa9b8', -- muted text
  fg3 = '#667e8c', -- comments
  accent = '#7fd4d4', -- primary
  accent2 = '#f0a898', -- secondary
  accent3 = '#4f9aa8', -- deep
  str = '#9ae0c0', -- strings
  num = '#f2cf9c', -- numbers, constants
  kw = '#7fd4d4', -- keywords
  fn = '#a9c4f0', -- functions
  typ = '#f0a898', -- types
  spec = '#f2cf9c', -- special
  ...
  hint = '#9ae0c0', -- hint
  add = '#9ae0c0', -- git add
  change = '#f2cf9c', -- git change
  del = '#f58b8b', -- git delete
}
